...
* on Thursday, December 4, 2014 at 3:28:24 PM China Standard Time
* Operating System: Version 8.1.1 (Build 12B435)
...
@interface SBLockScreenManager : NSObject <SBLockScreenViewControllerDelegate, SBUIBiometricEventObserver, SBUIBiometricEventMonitorDelegate> {
	...
	BOOL _isInLostMode;
	NSUInteger _failedMesaUnlockAttempts;
